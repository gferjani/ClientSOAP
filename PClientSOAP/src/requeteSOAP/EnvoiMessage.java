...
//On construit les différentes parties du message SOAP
//Il est possible de créer le message à partir d’un fichier externe.
public void creationMessage(String operation, float a, float b, String destination)    {
        try { 
...
//Envoi du  message
//dans le cas d’un message synchrone, l’envoi et la réception s’effectuent en une seule étape.
//Envoi du  message
//dans le cas d’un message synchrone, l’envoi et la réception s’effectuent en une seule étape.
public void EmmissionReception(String destination, float a, float b)
	...
	//le nom de la méthode et ses paramètres
{
        try {
           ...
           System.out.println("addition("+a+","+b+") = "+result.getNodeValue());
